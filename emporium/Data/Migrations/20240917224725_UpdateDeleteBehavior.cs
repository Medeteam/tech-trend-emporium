        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category_description = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Created_at = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    User_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Job_status_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobStatusJob_status_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductToCategories", x => new { x.Product_id, x.Category_id });
                    table.ForeignKey(
                        name: "FK_ProductToCategories_Categories_Category_id",
                        column: x => x.Category_id,
                        principalTable: "Categories",
                        principalColumn: "Category_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductToCategories_Products_Product_id",
                        column: x => x.Product_id,
                        principalTable: "Products",
                        principalColumn: "Product_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductToCategories_Category_id",
                table: "ProductToCategories",
                column: "Category_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductToCategories_Product_id",
                table: "ProductToCategories",
                column: "Product_id",
                unique: true);
